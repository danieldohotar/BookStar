...
public class BooksService {
    ...
    private void validate(Books book) throws ValidationException {
        ...
        if (StringUtils.isEmpty(book.getYear())) {
            errors.add("Year is Empty");
        }

        if (StringUtils.isEmpty(book.getPhotopath())) {
            errors.add("The path of the photo is Empty");
        }

        if (StringUtils.isEmpty(book.getSingle())) {
            errors.add("The path of the book is Empty");
        }

        if (StringUtils.isEmpty(book.getComment())) {

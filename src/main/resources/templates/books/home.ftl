...
<div id="carouselExampleIndicators" class="carousel slide" data-ride="carousel">
  ...
  <div class="carousel-inner">
    <div class="carousel-item active">
      <img src="/images/home/blackfridaybooks.jpg" class="d-block w-100" alt="blackfriday">
    </div>
...
<div class="row">
  ...
  <br></br>
    <div class="card">
      <div class="card-body">
        <h5  style=" color:green; text-align:center;" class="card-title"> <img src="/images/home/shipping.png" height = "50" width = "50" allign = "middle"> Free shipping in Romania on orders > 300 RON</h5>
  ...
  <br></br>
    <div class="card">
      <div class="card-body">
        <h5 style=" color:green;  text-align:center;" class="card-title" style = "text-align:center;"> <img src="/images/home/gift.png" height = "50" width = "50" allign = "middle"> Gift wrapping </h5>
  ...
  <br></br>
    <div class="card">
      <div class="card-body">
        <h5 style=" color:green; text-align:center; " class="card-title"> <img src="/images/home/bicycle.png" height = "50" width = "50" allign = "middle">  Bicycle Book Delivery in Bucharest </h5>
